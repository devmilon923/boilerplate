...
exports.createAbout = (0, catchAsync_1.default)(async (req, res) => {
    let decoded;
    try {
    ...
    const result = await (0, About_service_1.createAboutInDB)({ sanitizedContent });
...
exports.getAllAbout = (0, catchAsync_1.default)(async (req, res) => {
    const result = await (0, About_service_1.getAllAboutFromDB)();
...
exports.updateAbout = (0, catchAsync_1.default)(async (req, res) => {
    let decoded;
    try {
        decoded = (0, JwtToken_1.verifyToken)(req.headers.authorization);
    }
    ...
    const result = await (0, About_service_1.updateAboutInDB)(sanitizedDescription);
    if (!result) {
        return (0, sendError_1.default)(res, {
