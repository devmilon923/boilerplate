...
const validateUserLockStatus = (user) => __awaiter(void 0, void 0, void 0, function* () {
    if ((user === null || user === void 0 ? void 0 : user.blockStatus) === null || (user === null || user === void 0 ? void 0 : user.blockStatus) <= new Date()) {
        return true;
    }
    else {
